      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-white/50 text-sm">
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            <Link href="#" className="hover:text-[#9AE66E]">LinkedIn</Link>
            <Link href="#" className="hover:text-[#9AE66E]">Twitter</Link>
            <Link href="#" className="hover:text-[#9AE66E]">Instagram</Link>
          </div>
        </div>
      </div>
    </footer>
