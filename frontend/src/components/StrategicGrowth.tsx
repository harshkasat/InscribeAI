        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#E1F7CD] rounded-xl p-8 overflow-hidden relative">
            ...
            <p className="text-black/70 max-w-md mt-4 text-sm md:text-base relative z-10">
              As a progressive growth and performance company, we specialize in
              meticulously crafting innovative strategies that transcend
              conventional norms. Our commitment lies not only in meeting
              immediate sales objectives but in strategically positioning them
              for sustained success within the evolving market landscape.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="bg-[#F5E9AF] rounded-xl p-8 relative overflow-hidden">
              ...
              <p className="text-black/70 mt-4 text-sm md:text-base relative z-10">
                We don't just work for our clients, we work with them. We thrive
                on collaboration, building strong partnerships to understand
                each business's nuances.
              </p>
